...
env__WEBPACK_IMPORTED_MODULE_6__.name = 'production';

const setApplicationMenu = () => {
  electron__WEBPACK_IMPORTED_MODULE_2__["Menu"].setApplicationMenu(electron__WEBPACK_IMPORTED_MODULE_2__["Menu"].buildFromTemplate([]));
...
electron__WEBPACK_IMPORTED_MODULE_2__["app"].on("ready", () => {
  ...
  mainWindow.loadURL(url__WEBPACK_IMPORTED_MODULE_1___default.a.format({
    pathname: path__WEBPACK_IMPORTED_MODULE_0___default.a.join(__dirname, "files/index.html"),
    protocol: "file:",
    slashes: true
  }));
...
/*!***************************************!*\
  !*** ./src1/menu/dev_menu_template.js ***!
  \***************************************/
...
/*!****************************************!*\
  !*** ./src1/menu/edit_menu_template.js ***!
  \****************************************/
